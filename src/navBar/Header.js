  ...
  return (
    ...
    <Fragment>
      ...
      <Grid is_flex padding='4px 10px'>
        ...
        <Grid >
          <Button width='10vw' height='5vh' bgColor='#72acdb' color='#080538' text='로그인' _onClick={()=>{history.push('/login');}}></Button>
          <Button width='10vw' bgColor='#2ba677' color='#080538' text='회원가입' _onClick={()=>{history.push('/signup');}}></Button>
        </Grid>
      </Grid>
